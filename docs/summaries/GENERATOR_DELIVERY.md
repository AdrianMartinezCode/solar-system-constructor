...
Provide a configurable generator to quickly create interesting, editable solar systems (including multi-star hierarchies and optional grouping) without manual construction.

## Scope

- **In**:
  - Generator implementation + examples/demo
  - Documentation for usage and integration
- **Out**:
  - Unrelated app features not required to generate/edit systems
...
### Documentation
3. **`docs/design/PROCEDURAL_GENERATOR.md`** (500 lines)
...
4. **`docs/guides/GENERATOR_QUICKREF.md`** (350 lines)
...
1. Check `docs/guides/GENERATOR_QUICKREF.md` for common patterns
2. Check `docs/design/PROCEDURAL_GENERATOR.md` for detailed explanations
...
- Risk: generator changes can have wide UX/perf impact due to content volume.
- Rollback: revert to the prior generator version and/or disable generation entrypoints temporarily.

## Verification

- Run demo + validate output (see “Quick Commands” above).
...
- Add a small “seed regression” set (golden seeds) if deterministic outputs become a requirement.