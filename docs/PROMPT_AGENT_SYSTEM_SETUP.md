...
Important constraints for the model executing this prompt:
...
## Target Repo Additions (Structure)
...
- Add `agents/skills/WORKFLOW.md` (or append to `agents/agents.md`) describing:
  ...
  - how the PO decomposer should output:
    ...
    - `docs/prompts/TASK_<n>_<slug>.md`
...
### Per-task prompt template: `docs/prompts/TASK_<n>_<slug>.md`
...
## Output Format Requirements (for the model executing this prompt)
