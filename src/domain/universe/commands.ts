...
import type { Star, SmallBodyField, ProtoplanetaryDisk, NebulaRegion, PlanetaryRing } from '../../types';
...
export interface AddGroupCommand {
  ...
  payload: Omit<import('../../types').Group, 'id'>;
}

export interface UpdateGroupCommand {
  type: 'updateGroup';
  id: string;
  payload: Partial<import('../../types').Group>;
}
