...
export const SystemOverview: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'objects' | 'summary'>('objects');
  ...
  return (
    <div className="system-overview">
      <div className="overview-tabs">
        <button
          className={`overview-tab ${activeTab === 'objects' ? 'active' : ''}`}
          onClick={() => setActiveTab('objects')}
        >
          Objects ({counts.total})
        </button>
        <button
          className={`overview-tab ${activeTab === 'summary' ? 'active' : ''}`}
      ...
      {activeTab === 'summary' && (
        <div className="overview-summary-tab">
