...
import type { Star, Group, GroupChild, PlanetaryRing } from '../../types';
...
function applyUpdateSmallBodyField(
  state: UniverseState,
  id: string,
  patch: Partial<import('../../types').SmallBodyField>,
): CommandResult {
...
function applyAddProtoplanetaryDisk(
  state: UniverseState,
  disk: import('../../types').ProtoplanetaryDisk,
): CommandResult {
  return {
    nextState: {
      ...state,
...
function applyUpdateProtoplanetaryDisk(
  state: UniverseState,
  id: string,
  patch: Partial<import('../../types').ProtoplanetaryDisk>,
): CommandResult {
...
function applyUpdateNebula(
  state: UniverseState,
  id: string,
  patch: Partial<import('../../types').NebulaRegion>,
): CommandResult {
...
function applyReplaceSnapshot(
  ...
  snapshot: {
    ...
    rootGroupIds: string[];
    belts: Record<string, import('../../types').AsteroidBelt>;
    smallBodyFields: Record<string, import('../../types').SmallBodyField>;
    protoplanetaryDisks: Record<string, import('../../types').ProtoplanetaryDisk>;
    nebulae: Record<string, import('../../types').NebulaRegion>;
  },
): CommandResult {
  return {
    nextState: {
