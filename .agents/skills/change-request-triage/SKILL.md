...
description: Evaluate a change request for size/type/risk and blockers so it can be decomposed safely.
---
...
- When a change request is ambiguous, cross-cutting, or risky.
- When you need to classify work as small/medium/large to choose between direct execution vs PO decomposition.
